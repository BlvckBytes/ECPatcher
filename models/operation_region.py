...
class OperationRegion(ScopedEntity):
  ...
  def find_field_defs(self):
    ...
    self.blocks = list(map(lambda x: FieldBlock(x, self.offset, self.scope, self.lines), blockDefs))
